...
user && setBirthday(format(new Date(user.birthday),"yyyy-MM-dd"))
},[user])
const handleSubmit=(e)=>{
  e.preventDefault()
  dispatch(editUser(user._id,{username,email,age,gender,birthday},navigate))
}
  ...
  return (
    <Form style={{width:"40%",margin:"50px auto"}} onSubmit={handleSubmit} >
        ...
        <br/>
        <FormControl type='date' defaultValue={birthday} onChange={e=>setBirthday(e.target.value)} />
        <br/>
